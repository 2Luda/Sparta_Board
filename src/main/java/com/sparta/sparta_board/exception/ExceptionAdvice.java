...
public class ExceptionAdvice {
    ...
    public ResponseEntity handleBaseEx(BaseException exception) {
        ...
        return new ResponseEntity(new ExceptionDto(exception.getExceptionType().getErrorCode(),exception.getExceptionType().getErrorMessage()),exception.getExceptionType().gettHttpStatus());
    }
